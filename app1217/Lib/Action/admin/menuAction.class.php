...
class menuAction extends backendAction {
    ...
    public function index() {
        ...
        foreach($result as $r) {
            ...
            $r['str_display'] =$r['display']?'<img data-tdtype="toggle" data-field="display" data-id="'.$r['id'].'" data-value="'.$r['display'].'" src="__STATIC__/images/admin/toggle_enabled.gif"></img>':'<img data-tdtype="toggle" data-field="display" data-id="'.$r['id'].'" data-value="'.$r['display'].'" src="__STATIC__/images/admin/toggle_disabled.gif"></img>';
			$array[] = $r;
        }
        $str  = "<tr>
				...
				<td align='center'>\$str_display</td>

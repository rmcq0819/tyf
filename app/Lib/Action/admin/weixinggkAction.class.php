<?php
class weixinggkAction extends backendAction
{
	...
	public function edit()
	{
		if (IS_POST) {
			...
			$this->success('更新成功',U('ggk/edit',array('id'=>$id)));
		}else{
			//读取大转盘配置信息
			$ggk = M('ggk_config');
			$id=$_GET['id'];
			$zp_info = $ggk->where("id=".$id)->find();

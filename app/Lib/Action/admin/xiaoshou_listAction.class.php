...
class xiaoshou_listAction extends backendAction
{
    ...
    public function index(){
		...
		$data['b.status']=array('in','2,3,4,5,7');
        if($_GET['keyword']||$_GET['time']){
            ...
            $res=M('order_detail')->join("a left join weixin_item_order b on a.orderId=b.orderId")->field("a.id,a.title,a.price,a.quantity,a.orderId,b.add_time")->where($data)->order('b.support_time desc')->select();
        }

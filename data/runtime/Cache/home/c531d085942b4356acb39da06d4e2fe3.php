...
label *{
		...
		wx.config({
		  ...
		  wx.ready(function () {
			 wx.onMenuShareTimeline({
				...
				imgUrl: "http://yooopay.com/Tpl/home/default/Style/index-images/activity/meizhuang.png", // 分享图标
			});
	...
	<body>
		...
		<div id="header">
			<img src="../Style/index-images/activity/meizhuang.png" alt="头部" class="am-img-responsive" />
		</div>
		
		<div id="main">
			
			<div class="center-img">
				<div class="left" onclick="location='<?php echo U('Activity/muying');?>'">
					<img src="../Style/index-images/activity/<?php if($flag >= 2): ?>back<?php else: ?>click2<?php endif; ?>.png" alt="1-2日专场回顾" class="am-img-responsive"/>
				</div>
				<div class="center">
					<img src="../Style/index-images/activity/meizhuang1.png" alt="" class="am-img-responsive"/>
				</div>
				<div class="right" onclick="location='<?php echo U('Activity/meishi');?>'">
					<img src="../Style/index-images/activity/<?php if($flag <= 2): ?>next2<?php else: ?>click4<?php endif; ?>.png" alt="5-7日专场报告" class="am-img-responsive"/>
				</div>

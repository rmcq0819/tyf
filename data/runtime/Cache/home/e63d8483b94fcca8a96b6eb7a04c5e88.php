...
label *{
	...
	<body style="background:#f3f3f3;">
		<div class="topnav">
			<a href="<?php echo U('Zhuangpan/index');?>" onClick="window.history.back(-1);" class="back">
		...
		<div class="tab1" id="tab1" style="margin-top: 90px;">
			...
			<div class="am-g choose-time">
			  	<div class="am-u-sm-5" style="padding-left: 2px;">
			  		<span class="am-margin-right" id="my-start">
			    	 	<span>开始日期</span>：
			    	 	<span id="my-startDate" style="color: rgb(240,93,0);"><?php echo (date('Y-m-d',$stime)); ?></span>
			    	 </span>
			  	</div>
			  	<div class="am-u-sm-5" style="padding-left: 6px;">
			  		<span class="am-margin-right" id="my-end">
			    		<span>结束日期：</span>
			    		<span id="my-endDate" style="color: rgb(240,93,0);"><?php echo (date('Y-m-d',$etime)); ?></span>
			    	</span>
			  	</div>
			...
			<input type="hidden" name="stime" id="stime" value="<?php echo (date('Y-m-d',$stime)); ?>">
			<input type="hidden" name="etime" id="etime" value="<?php echo (date('Y-m-d',$etime)); ?>">
			<div class="menudiv" style="margin-top: px;">
				
				<!--全部-->
				<div id="con_one_1">
					<?php if(!empty($list)): ?><dl>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><dt style="background-color: white;">
							<div class="am-g">
  								<div class="am-u-sm-2">
  									<img src="../Style/index-images/activity/<?php echo ($vol["pic"]); ?>" alt="" class="am-img-responsive" style="height: 43px;"/>
  								</div>
  								<div class="am-u-sm-7">
  									<p class="title">获得<?php echo ($vol["prize"]); ?></p>
									<?php if($vol["kind"] == 1): ?><p class="content">已存入"会员中心"-"我的范票"</p><?php endif; ?>
									<?php if($vol["kind"] == 2): ?><p class="content">已存入"会员中心"-"优惠券"</p><?php endif; ?>
									<?php if($vol["kind"] == 3): ?><p class="content">我们会尽快邮寄到您手中</p><?php endif; ?>
									<?php echo ($vol["username"]); ?>
  								</div>
  								<div class="am-u-sm-3">
  									<p class="del" onclick="del(this,<?php echo ($vol["id"]); ?>);"><img src="../Style/index-images/shopcar_07.png" alt="删除"/></p>
  									<p class="time"><?php echo (date('m月d日',$vol["draw_time"])); ?></p>
  								</div>
							</div>
					...
					<div class="no-re">
						...
						<p>你还没开始抽奖耶~，赶快<span onclick="location.href='<?php echo U('Zhuangpan/index');?>'">试下手气</span>吧！</p>
					</div><?php endif; ?>
				</div>
				...
				<div id="con_one_2" style="display:none;">
					...
					<?php if(!empty($list1)): ?><dl>
						<?php if(is_array($list1)): $i = 0; $__LIST__ = $list1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><dt style="background-color: white;">
							<div class="am-g">
  								<div class="am-u-sm-2">
  									<img src="../Style/index-images/activity/<?php echo ($vol["pic"]); ?>" alt="" class="am-img-responsive" style="height: 43px;"/>
  								</div>
				...
				<div id="con_one_3" style="display:none;">
					<?php if(!empty($list2)): ?><dl>
						<?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><dt style="background-color: white;">
							<div class="am-g">
  								<div class="am-u-sm-2">
  									<img src="../Style/index-images/activity/<?php echo ($vol["pic"]); ?>" alt="" class="am-img-responsive" style="height: 43px;"/>
  								</div>
				...
				<div id="con_one_4" style="display:none;">
					<?php if(!empty($list3)): ?><dl>
						<?php if(is_array($list3)): $i = 0; $__LIST__ = $list3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><dt style="background-color: white;">
							<div class="am-g">
  								<div class="am-u-sm-2">
  									<img src="../Style/index-images/activity/png/<?php echo ($vol["pic"]); ?>" alt="" class="am-img-responsive" style="height: 43px;"/>
  								</div>
  								<div class="am-u-sm-7">
  									<p class="title">获得<?php echo ($vol["prize"]); ?></p>

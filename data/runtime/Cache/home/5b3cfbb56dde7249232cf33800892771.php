		...
		<div class="swiper-container" id="swiper-container-v">
		        ...
		        <section class="swiper-slide swiper-slide2 swiper-slide-v" style="height: 100%;">
		        	...
		        	<div style="width: 100%;height: 55%;background-color: rgb(255,241,0);">
		        		<div style="position: relative; left: 0px;">
		  				...
		  				<img src="../Style/index-images/activity/s22-4.png" alt="" class="am-img-responsive ani" style="width: 70%; margin: 0 auto; margin-top: 10%;" swiper-animate-effect="flipInY" swiper-animate-duration="0.9s" swiper-animate-delay="0.6s"/>
		    ...
		    <!-------------slide3----------------->
		        <section class="swiper-slide swiper-slide3 swiper-slide-v" style="height: 100%;">
		        	...
		        	<div style="width: 100%;height: 55%;background-color: rgb(255,241,0);">
		        		...
		        		<p class="ani" style="width: 80%;text-align: center; color: rgb(240,93,0); font-size: 17px; margin: 0 auto;margin-top: 7%; " swiper-animate-effect="zoomIn" swiper-animate-duration="1s" swiper-animate-delay="0.9s" >您是第&nbsp;<span id="wei" style="font-weight: bold; font-size: 21px;"><?php echo ($user['id']*3); ?></span>&nbsp;位加入团洋范的创业人</p>
		        		<p class="ani" style="text-align: center;color: rgb(240,93,0); font-size: 17px; margin-top: 20px;" swiper-animate-effect="zoomIn" swiper-animate-duration="1s" swiper-animate-delay="1.3s" >您很棒，因为您懂得抓住时机</p>
		        	</div>
		    ...
		    <!-------------slide4----------------->
		        <section class="swiper-slide swiper-slide4 swiper-slide-v" style="height: 100%;">
		        	...
		        	<div style="width: 100%;height: 55%;background-color: rgb(255,241,0);">
		        		...
		        		<p class="ani" style="width: 80%; color: rgb(240,93,0); font-size: 17px; text-align: center; margin: 0 auto; margin-top: 2%;" swiper-animate-effect="slideInRight" swiper-animate-duration="0.5s" swiper-animate-delay="1.5s">因为您懂得参与期间的道理，有助于迅速壮大队伍</p>
						<?php else: ?>
			...
			<!-------------slide5----------------->       
		  		<section class="swiper-slide swiper-slide5 swiper-slide-v" style="height: 100%;">
		        	...
		        	<div style="width: 100%;height: 55%;background-color: rgb(255,241,0);">
		        		...
		        		<p class="ani" style="width: 80%;height: 50px; line-height: 46px ;color: rgb(240,93,0); text-align: center; border: solid 2px rgb(240,93,0); border-radius: 3px; font-size: 26px; margin: 0 auto; margin-top: 6%; font-weight: bold;" swiper-animate-effect="bounceIn" swiper-animate-duration="0.8s" swiper-animate-delay="0.8s"><?php echo ($points); ?>&nbsp;<span style="font-size: 20px;">张范票</span></p>
		        		<p class="ani" style="width: 82%;color: rgb(240,93,0);text-align: center; margin: 0 auto; font-size: 15px; margin-top: 5%;" swiper-animate-effect="bounceIn" swiper-animate-duration="0.8s" swiper-animate-delay="1.2s">（要知道，范团是干粮，范票也是钱啊）</p>
		        		<p class="ani" style="width: 80%;color: rgb(240,93,0);text-align: center; margin: 0 auto; font-size: 15px; margin-top: 5%; line-height: 26px;" swiper-animate-effect="bounceIn" swiper-animate-duration="0.8s" swiper-animate-delay="1.7s">谢谢您，时刻关注团洋范的一切，王大大给您1028个赞</p>
		        	</div>
	        ...
	        <!-------------slide7----------------->       
		  		<section class="swiper-slide swiper-slide7 swiper-slide-v" style="height: 100%;">
		        	<div style="width: 100%; height: 33%; background: url(../Style/index-images/activity/bg-22.jpg); background-size: cover;">
		        		<p style="padding-top: 30%;"><img src="../Style/index-images/activity/ssss7-1.png" alt="成为经纪人" class="am-img-responsive" style="width: 70%; margin: 0 auto;"/></p>
		        	</div>
		        	<div style="width: 100%;height: 55%;background-color: rgb(255,241,0); text-align: center; font-size: 15px;">
						<?php if($fu_time > 0): ?><p class="ani" style="width: 80%;text-align: left; color: rgb(240,93,0); font-size: 17px;padding-top: 5%;" swiper-animate-effect="zoomIn" swiper-animate-duration="1s" swiper-animate-delay="0.2s" >【<?php echo (date("Y年m月d日",$fu_time)); ?>】</p>
							<img src="<?php echo ($fuser['cover']); ?>" alt="用户" class="am-img-responsive am-circle ani" style="width: 19%; margin: 0 auto;" swiper-animate-effect="myFlip" swiper-animate-duration="1s" swiper-animate-delay="0.5s" />
							<p class="ani" style="width: 80%; text-align: center; margin: 0 auto; color: rgb(240,93,0); font-size: 14px; margin-top: 2px;" swiper-animate-effect="myFlip" swiper-animate-duration="1s" swiper-animate-delay="0.2s" ><?php echo ($fuser['username']); ?></p>
							<p class="ani" style="width: 80%;text-align: center; color: rgb(240,93,0); font-size: 17px; margin: 0 auto;margin-top: 7%; " swiper-animate-effect="zoomIn" swiper-animate-duration="1s" swiper-animate-delay="0.9s" >在您的线上商城购买了商品</p>
							<p class="ani" style="text-align: center;color: rgb(240,93,0); font-size: 17px; margin-top: 20px;" swiper-animate-effect="zoomIn" swiper-animate-duration="1s" swiper-animate-delay="1.3s" >这是您的第一位顾客</p>
							<p class="ani" style="text-align: center;color: rgb(240,93,0); font-size: 17px; margin-top: 20px;" swiper-animate-effect="zoomIn" swiper-animate-duration="1s" swiper-animate-delay="1.3s" >别忘了，待会和他说声‘谢谢’！</p>
						<?php else: ?>
							<p class="ani" style="color: rgb(240,93,0); font-size: 18px; text-align: center; padding-top: 20%;" swiper-animate-effect="rubberBand" swiper-animate-duration="0.9s" swiper-animate-delay="0.5s">你还没顾客，要加油哦~~</p><?php endif; ?>
		        	</div>
		        	<div style="width: 100%; height: 12%;background-color: rgb(153,108,51);">
		        		<div class="am-g">
							<div class="am-u-sm-4">
  							...
  							<div class="am-u-sm-8">
  								<p class="ani" style="color: white; font-size: 17px; margin-top: 12px;text-align: center;" swiper-animate-effect="bounce" swiper-animate-duration="0.9s" swiper-animate-delay="2s">购物我只在团洋范商城</p>
  							</div>
						</div>
		    ...
		    <!-------------slide8----------------->       
		  		<section class="swiper-slide swiper-slide8 swiper-slide-v" style="height: 100%;">
		        	<div style="width: 100%; height: 33%; background: url(../Style/index-images/activity/bg-22.jpg); background-size: cover;">
		        		<p style="padding-top: 30%;"><img src="../Style/index-images/activity/ssss8-1.png" alt="成为经纪人" class="am-img-responsive" style="width: 70%; margin: 0 auto;"/></p>
		        	</div>
		        	<div style="width: 100%;height: 55%;background-color: rgb(255,241,0); text-align: center; font-size: 15px;">
		  				<div>
		  					<img src="../Style/index-images/activity/s4-2.png" alt="" class="am-img-responsive ani" style="width: 110px; margin: 0 auto; margin-top: -10px; padding-top:0px;" swiper-animate-effect="slideInRight" swiper-animate-duration="0.9s" swiper-animate-delay="0s"/>		  							  					
		  				</div>
						<?php if($muserId > 0): ?><img src="<?php echo ($muser['cover']); ?>" alt="用户" class="am-img-responsive am-circle ani" style="width: 15%; margin: 0 auto; margin-top: 4%;" swiper-animate-effect="slideInRight" swiper-animate-duration="1s" swiper-animate-delay="0.5s" />
		        		<p class="ani" style="width: 80%; text-align: center; margin: 0 auto; color: rgb(240,93,0); font-size: 14px; margin-top: 2px;" swiper-animate-effect="slideInRight" swiper-animate-duration="1s" swiper-animate-delay="0.5s" ><?php echo ($muser['username']); ?></p>
		        		<p class="ani" style="width: 80%; color: rgb(240,93,0); font-size: 17px; text-align: center; margin: 0 auto; margin-top: 5%;" swiper-animate-effect="slideInRight" swiper-animate-duration="1s" swiper-animate-delay="0.9s">在您的店铺购物最多</p>
		        		<p class="ani" style="width: 80%; color: rgb(240,93,0); font-size: 17px; text-align: center; margin: 0 auto; margin-top: 2%;" swiper-animate-effect="slideInRight" swiper-animate-duration="1s" swiper-animate-delay="1.2s">如果可以，给他发个小小的红包致谢吧！</p>
						<?php else: ?>
							<p class="ani" style="color: rgb(240,93,0); font-size: 18px; text-align: center; padding-top: 20%;" swiper-animate-effect="rubberBand" swiper-animate-duration="0.9s" swiper-animate-delay="0.5s">你还没顾客，要加油哦~~</p><?php endif; ?>
		        	</div>
		        	<div style="width: 100%; height: 12%;background-color: rgb(153,108,51);">
		    ...
		    <!----------------slide9-------------->
		        <section class="swiper-slide swiper-slide9 swiper-slide-v" style="height: 100%; background: url(../Style/index-images/activity/s8-1.jpg); background-size: cover;">
		        	<div style="margin-top: 65%; text-align: center; color: rgb(235,94,0); font-size: 18px; font-weight: bold;">
		        		...
		        		<button onclick="location.href='<?php echo U('Activity/review_2016');?>'" style="width: 190px; height: 30px; color: rgb(240,93,0); font-size: 14px; background-color: white; border: none; border-radius: 16px;margin-top:25px;" class="ani" swiper-animate-effect="slideInUp" swiper-animate-duration="3.5s" swiper-animate-delay="0s">查看团洋范我的2016</button>
		        		<button onclick="location.href='<?php echo U('appdownload/index');?>'" style="width: 190px; height: 30px; color: white; font-size: 14px; background-color: rgb(232,104,32); border: none; border-radius: 16px; margin-top: 20px;" class="ani" swiper-animate-effect="slideInUp" swiper-animate-duration="4.5s" swiper-animate-delay="0s">下载团洋范商城APP</button>
			...
			<div class="arrow-box" style="height: 100px; background-color: none;">
  			...
  			<!-------------音乐-------------->
	   		<div class="music" style="width: 50px; height: 50px; z-index: 1000; position: fixed; right: 0px; top: 55px;">
	        	...
	        	<audio id="aud" src="../Style/music/Hit Tunes - Unconditionally (Originally Performed by Katy Perry) - Instrumental.mp33" loop="loop" autoplay></audio>
	    	</div>

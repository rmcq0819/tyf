...
.login2{ color:#009900; text-align:center; display:none;}
	...
	<body>
		...
		<div id="main">
			<img src="../Style/index-images/404.png" alt="404" class="am-img-responsive" />
		</div>
		<div id="content">
			<p>有点尴尬诶 -_-#</p>
			<p>我们可能无法找到你需要的内容</p>
		...
		<div id="button">
			<button><i class="am-icon-rotate-left"></i>&nbsp;&nbsp;<a href="index.php?shares=<?php echo ($info["id"]); ?>" style="color:#fff;">返回首页</a></button>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<button><i class="am-icon-refresh"></i>&nbsp;&nbsp;<a href="#" style="color:#fff;">刷新试试</a></button>
		</div>
	</body>

...
label *{
    pointer-events: none;
		...
		wx.config({
		  ...
		  wx.ready(function () {
			 wx.onMenuShareTimeline({
				...
				imgUrl: "http://yooopay.com/Tpl/home/default/Style/index-images/activity/muying.jpg", // 分享图标
			});
		...
		<style>
			* {
			...
			#main{
				background: url(../Style/index-images/activity/muying-bg.jpg); background-size: cover;
			}
	...
	<body>
		...
		<div id="header">
			<img src="../Style/index-images/activity/muying.jpg" alt="头部" class="am-img-responsive" />
		</div>
		...
		<div id="main">
			...
			<div class="center-img">
				<div class="left">
					<img src="../Style/index-images/activity/muying1.jpg" alt="母婴" class="am-img-responsive"/>
				</div>
				<div class="right" onclick="location='<?php echo U('Activity/meizhuang');?>'">
					<img src="../Style/index-images/activity/<?php if($flag == 1): ?>next<?php else: ?>click1<?php endif; ?>.png" alt="3-4日专场" class="am-img-responsive"/>
				</div>

...
.topnav .back{ position:absolute; left:8px;top:0px;}
</style>
</head>
...
<div class="tixianshu" style="padding-top:50px;"><img src="../Style/images/tixianimg.png">
<p>可提现金额</p><p style="font-size:18px; font-family: '微软雅黑';">￥<?php echo ($keti); ?></p></div>
<a href="<?php echo U('User/tixian');?>"><button type="button" class="am-btn am-btn-default am-radius tixianon">申请提现</button></a>

<ul class="am-list tixiantimain">
  <li><a href="#"><span>￥0.00<img src="../Style/images/pic11.png"></span>待结算金额</a></li>
  <li><a href="#"><span>￥<?php echo ($keti); ?><img src="../Style/images/pic11.png"></span>可提现金额</a></li>
  <li><a href="#"><span>￥<?php echo ($zhengtx); ?><img src="../Style/images/pic11.png"></span>提现中金额</a></li>
  <li><a href="#"><span>￥<?php echo ($yiti); ?><img src="../Style/images/pic11.png"></span>已提现金额</a></li>
</ul>


<ul class="am-list tixiantimain">
  <li><a href="<?php echo U('User/fenchenglist',array('time'=>one));?>"><span><img src="../Style/images/pic11.png"></span>奖金明细</a></li>
</ul>

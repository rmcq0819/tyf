...
<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
    ...
    <tr>
        ...
        <td class="blue">
            <?php echo ($board_info["name"]); ?> (<?php echo ($board_info["width"]); ?>*<?php echo ($board_info["height"]); ?>)
        </td>
    </tr>
    <tr>
    ...
    <tr id="ad_image" class="bill_media">
		...
		<?php if($info["type"] == 'image'): if(!empty($info['content'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo ($img_dir); echo ($info["content"]); ?>"><img src="__STATIC__/images/filetype/image_s.gif" /></span><?php endif; endif; ?>
		</td>
    </tr>

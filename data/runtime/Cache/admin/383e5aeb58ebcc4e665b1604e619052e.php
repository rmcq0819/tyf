            ...
            <tr>
                ...
                <div class="explain_col">
                   ...
                   &nbsp;&nbsp; 会员名 :
                    ...
                    <form action="<?php echo U('newfenchenglist/excelout');?>" method="post"><input type="submit" class="btn" style="float:right;top:-27px;" value="导出数据"> </form>
                </div>
                </td>
            </tr>
        </tbody>
    	...
    	<tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
              <!--   <td align="center"><input type="checkbox" class="J_checkitem" value="<?php echo ($val["id"]); ?>"></td> -->
                ...
                <td align="center"><span data-tdtype="royalty" data-field="price" data-id="<?php echo ($val["price"]); ?>" ><?php if($val["is_find"] == ''): ?>已确认<?php else: ?>待确认<?php endif; ?></span></td>

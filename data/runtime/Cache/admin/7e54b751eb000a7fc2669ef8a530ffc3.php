...
<div class="pad_lr_10">
	...
	<table width="100%" class="table_form">
		...
		<tr>
            <th>订单运费设置:</th>
            <td><input type="text" name="setting[site_yunfei]" size="10" class="input-text" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')" onafterpaste="this.value=this.value.replace(/[^0-9.]/g,'')" value="<?php echo C('pin_site_yunfei');?>" />元</td>
        </tr>
         <tr>
            <th>微信公众号二维码 :</th>
            <td>
        ...
        <tr>
		 ...
		 <tr>
            ...
            <td><textarea rows="2" cols="50" name="setting[alipayhome]"><?php echo C('pin_alipayhome');?></textarea>
             <p>如：https://me.alipay.com/wzhceo，客户付款后，请查看支付记录，并在订单处理中手动完成后台付款操作！</p>如果不需要接入个人支付宝主页收款请不要填写内容。</td>

...
<form id="info_form" action="<?php echo U('messages/index');?>&id=<?php echo ($list["id"]); ?>" method="post" enctype="multipart/form-data">
<div class="pad_lr_10">
	<div class="col_tab">
			...
			<div class="content_list pad_10">
				<table width="100%" cellspacing="0" class="table_form">
					 <tr>
						<th>标题:</th>
						<td>
							<input type="text" name="title" id="J_title" value="<?php echo ($list["title"]); ?>" class="input-text"  size="30">
		                </td>
					</tr>	     
		            <tr class="none">
						<th>详细内容 :</th>
		                <td><textarea name="info" id="info"  style="width:68%;height:400px;visibility:hidden;resize:none;"><?php echo ($list["info"]); ?></textarea></td>
					</tr>
				</table>
			</div>
        </div>
